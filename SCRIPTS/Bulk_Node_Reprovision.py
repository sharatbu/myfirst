...
##################################################### hardware category and table name
dyna_table_name=''
...
headers = {'content-type': 'application/soap+xml', 'SOAPAction': 'http://Airspan.Netspan.WebServices/NodeReprovision'}
logging.debug(url)
##########################################################DB
try:
        print("connecting db")
...
################# Network profile with highest usage count --SQL
        ...
        sql = """
select top 1000 BoxId  from BaseStation with (nolock) where managementmode =1 and dbid in ( select bsdbid from %s with (nolock) where connectionstate = 0)
""" %dyna_table_name
...
def NodeReprovision():
    ...
    <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
        ...
        <soap:Body>
            <NodeReprovision xmlns="http://Airspan.Netspan.WebServices">""" % (nbif_username, nbif_password)
